...
12. När sidan är granskad av någon annan trycker du på den gröna knappen "Squash and merge". Står det något annat på den gröna knappen så trycker du på pilen jämte och väljer "Squash and merge" innan du trycker på knappen.
<img width="868" height="1352" alt="image" src="https://github.com/user-attachments/assets/e1d22917-6562-4dc7-b44a-301e71e8ed29" />

13. Tryck på "Confirm squash and merge".
<img width="897" height="450" alt="image" src="https://github.com/user-attachments/assets/c6205c50-a135-4104-8a01-a7bc37d5dfc2" />

14. Verifiera att dina ändringar syns på hemsidan (den riktiga hemsidan).
